...
MARKDOWN_HELP = """
मार्कडाउन टेलीग्राम द्वारा समर्थित एक बहुत शक्तिशाली स्वरूपण उपकरण है। 
{}कुछ सुधार हैं, यह सुनिश्चित करने के लिए कि सहेजे गए नोटों को सही ढंग से पार्स किया गया है और आपको बटन बनाने की अनुमति है।
...
#__main__
    #Module names
        "Admin": "प्रशासक",
        "AFK": "अनुपस्थित (AFK)",
        "AntiFlood": "रोकथाम-Antiflood",
        "Bans": "प्रतिबंध",
        "Word Blacklists": "शब्द ब्लैकलिस्ट्स",
        "Filters": "फिल्टर",
        "Command disabling":"कन्मद अक्षम करना",
        "Antispam security": "एंटी स्पैम सुरक्षा",
        "Locks": "लॉका",
        "Log Channels": "लॉग चैनल",
        "Misc": "विविध",
        "Purges": "शुद्ध करना(purge)",
        "Muting & Restricting": "म्यूट & बंधन",
        "Notes": "नोट",
        "Reporting": "रिपोर्टिंग",
        "RSS Feed": "RSS चारा",
        "Rules": "नियम",
        "Connections": "सम्बन्ध",
        "Bios and Abouts": "बायोस एंड अबाउट",
        "Warnings": "चेतावनी",
        "Welcomes/Goodbyes":"स्वागत / अलविदा",
